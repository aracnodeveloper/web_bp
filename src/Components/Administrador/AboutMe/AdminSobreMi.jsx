      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Gestiona los textos biográficos que aparecen en la sección "Sobre
            Mí" (Introducción)
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-4">
                {editingItem
                  ? "Editar Texto Biográfico"
                  : "Nuevo Texto Biográfico"}
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    El título es solo para identificación administrativa, no se
                    muestra al público
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Este texto aparecerá en la sección de Introducción junto a
                    tu fotografía
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Clase CSS del icono (opcional, actualmente no se muestra en
                    el diseño)
                  </p>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-4">
                  <p className="text-xs text-yellow-800">
                    <strong>💡 Consejo:</strong> Puedes crear múltiples
                    párrafos. Solo los marcados como "activos" se mostrarán en
                    la página. Los textos se mostrarán en el orden en que fueron
                    creados.
                  </p>
                </div>
