...
const AdminLocation = () => {
    ...
    const countries = items.filter(item => item.type === 'country').sort((a, b) => (a.orderIndex || 0) - (b.orderIndex || 0));
    const cities = items.filter(item => item.type === 'city').sort((a, b) => (a.orderIndex || 0) - (b.orderIndex || 0));
    ...
    return (
        <div>
            <div className="mb-6">
                <h2 className="text-xl font-semibold text-gray-800">Distribución Geográfica</h2>
                ...
                <div className="overflow-x-auto">
                    ...
                    {(activeTab === 'country' ? countries : cities).length === 0 && (
                        <div className="text-center py-12 text-gray-500">
                            ...
                            <p>No hay {activeTab === 'country' ? 'países' : 'ciudades'} configurados</p>
                        </div>
                    )}
                </div>
            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder={formData.type === 'country' ? 'Ej: Ecuador' : 'Ej: Cuenca'}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#96c121] focus:border-transparent"
                                        required
                                    />
                                </div>
